...
def plot_e_field(data, ga, timestep, label_ab): #"""Plot of E field at a single time step"""
...
def plot_amp(data, ga, freq, label): #""" Plot of the Fourier transform amplitude at a single time step"""
